...
const ContactForm: React.FC<ContactFormProps> = () => {
  ...
  return (
    <section className=" h-[90vh] bg-slate-400 containerFormulaire">
      <div className="pt-10">
        <div className="">
          <div className="">
            <div className="bg-white relative flex shadow-lg w-[50%]  mx-auto my-auto h-[70vh] rounded-t-3xl  rounded-br-none">
              <div className="">
                <form onSubmit={handleSubmit} className="formulaire rounded-none border-b border-gray-300 p-6 pb-9 pt-20 pl-10 pr-40 ">
