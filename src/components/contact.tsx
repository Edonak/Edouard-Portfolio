            ...
            <div className="w-[60%] ">
                <form  onSubmit={handleSubmit} className="">
                  <div className="rounded-none border-b border-gray-300 p-6 pb-9 pt-20 pl-10 pr-40 ">
                    ...
                    <ButtonGeneral value="Envoyer" className="contact_form_submit w-[100%] text-white hover:bg-transparent hover:text-blue-800 hover:border-blue-800 font-semibold  py-3 px-4 mt-8 border border-white rounded-full" />
                  </div>
                </form>
